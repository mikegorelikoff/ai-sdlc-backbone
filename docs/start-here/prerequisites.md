...
- Codex as the currently validated project-scoped agent host.
...
[pinned, reviewable installation path](../how-to/install.md#inspect-and-install-an-immutable-release)
