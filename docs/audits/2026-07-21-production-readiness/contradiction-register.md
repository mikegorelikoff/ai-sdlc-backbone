...
| CR-009 | Approval record vs authenticated human authority | Valid TOON proves approval; protected system proves approval | Helper reports structural validity only; external protected authorization is required | Change-apply test asserts limitation status |
