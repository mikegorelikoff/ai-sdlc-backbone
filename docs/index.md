...
Use `claude-code-project` for Claude Code. Windows and compatible custom agent
roots use the [cross-platform installation path](how-to/install.md). The second
