...
After placing your license key in `AI_SDLC_LICENSE_KEY`, or when ready to enter
...
Run the profile-specific verification command printed after installation. The
installer stops if license validation, download, checksum verification, safe
extraction, or the controlled install operation fails.

Continue with [Start here](start-here/index.md). Read [How it works](how-it-works/index.md)
for the canonical mental model and [Reference](reference/index.md) for exact
public contracts.
