...
| [`ai-sdlc-context-cache`](skills/ai-sdlc-context-cache.md) | Software Engineer | Cross-feature context engineering and retrieval | `context-cache` | disposable SQLite state plus canonical TOON receipts and context packs |
