...
| [`ai-sdlc-flow`](skills/ai-sdlc-flow.md) | QA, BA, PM, PO, Software Engineer | Cross-lifecycle guided entry | `core` | `ai-sdlc-flow/v2` Markdown, TOON, or JSON decision card and one bounded Apply result |
