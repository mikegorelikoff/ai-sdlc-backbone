...
| [`ai-sdlc-host-adapter`](skills/ai-sdlc-host-adapter.md) | Software Engineer | Portable execution handoff | `core` | `_ai_sdlc/adapters/<adapter-id>/negotiation.toon` and its `negotiation.md` human projection |
