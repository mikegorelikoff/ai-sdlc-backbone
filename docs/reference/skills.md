...
| [`ai-sdlc-context-cache`](skills/ai-sdlc-context-cache.md) | Software Engineer | Cross-feature context engineering and retrieval | `context-cache` | disposable SQLite state and HTML graph view, plus canonical TOON receipts and context packs |
...
| [`ai-sdlc-delivery-graph`](skills/ai-sdlc-delivery-graph.md) | QA, BA, PM, PO, Software Engineer | Traceability and readiness | `core` | complete `_ai_sdlc/delivery-graph.toon` for agents, plus `_ai_sdlc/delivery-graph.toon` for schema/interoperability and `_ai_sdlc/delivery-graph.md` for human review when `--write` is requested |
...
| [`ai-sdlc-doctor`](skills/ai-sdlc-doctor.md) | Software Engineer | Installation and upgrade operations | `core` | `_ai_sdlc/doctor/report.toon` or `_ai_sdlc/upgrades/<id>/plan.toon`, with optional human Markdown |
| [`ai-sdlc-engineering-quality-gate`](skills/ai-sdlc-engineering-quality-gate.md) | QA, Software Engineer | Mandatory post-implementation engineering quality gate | `core` | Canonical TOON context and quality report plus a concise evidence-based presentation |
...
| [`ai-sdlc-flow`](skills/ai-sdlc-flow.md) | QA, BA, PM, PO, Software Engineer | Cross-lifecycle guided entry | `core` | `ai-sdlc-flow/v3` canonical TOON or human Markdown decision card and one bounded Apply result |
...
| [`ai-sdlc-host-adapter`](skills/ai-sdlc-host-adapter.md) | Software Engineer | Portable execution handoff | `core` | `_ai_sdlc/adapters/<adapter-id>/negotiation.toon`, its human projection, and `_ai_sdlc/effects/<idempotency-key>.toon` after execution |
| [`ai-sdlc-package-trust`](skills/ai-sdlc-package-trust.md) | Software Engineer | Package trust and local observability | `core` | `_ai_sdlc/trust/<package-id>/decision.toon` or `_ai_sdlc/metrics/local.toon`, with optional human Markdown |
| [`ai-sdlc-policy`](skills/ai-sdlc-policy.md) | QA, PM, Software Engineer | Governance and control evaluation | `core` | `_ai_sdlc/policy-resolution.toon` or fingerprint-addressed TOON records below `_ai_sdlc/policy-decisions/` when `--write` is requested |
...
| [`ai-sdlc-project-context`](skills/ai-sdlc-project-context.md) | Software Engineer | Cross-feature repository context | `core` | `_ai_sdlc/context/project-context.{md,toon}` and optional topology and task-pack records below `_ai_sdlc/context/` |
...
| [`ai-sdlc-runtime`](skills/ai-sdlc-runtime.md) | Software Engineer | Controlled execution | `core` | immutable `plan.toon`, append-only `journal/*.toon`, and the replay-derived `state.toon` projection below `_ai_sdlc/runs/<run-id>/` |
| [`ai-sdlc-scheduler`](skills/ai-sdlc-scheduler.md) | Software Engineer | Durable execution orchestration | `unregistered` | Canonical scheduler state, dispatch records, isolated runtime runs, and handoff evidence. |
...
| [`ai-sdlc-workflow`](skills/ai-sdlc-workflow.md) | Software Engineer | Controlled execution planning | `core` | `workflow-plan.toon`, `run-plan.toon`, and `plan.md` below `_ai_sdlc/workflows/<workflow-id>/` |
