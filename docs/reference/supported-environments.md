...
curl -fsSL https://raw.githubusercontent.com/mikegorelikoff/ai-sdlc-harness/v4.3.0/install.sh | sh -s -- claude-code-project
```
...
Consumer instructions resolve annotated tag `v4.3.0` to an exact commit. Local
