...
curl -fsSL https://raw.githubusercontent.com/mikegorelikoff/ai-sdlc-harness/v4.2.1/install.sh | sh -s -- claude-code-project
```
...
Consumer instructions resolve annotated tag `v4.2.1` to an exact commit. Local
