...
| --- | --- | --- | --- |
| [`v4.4.0`](https://github.com/mikegorelikoff/ai-sdlc-harness/tree/v4.4.0) | `4.1.0` | Current stable release; adds a cross-platform Python bootstrap, portable Windows/POSIX locking, and a configurable project skills root for Agent Skills-compatible hosts | No API migration; existing named profiles remain unchanged |
