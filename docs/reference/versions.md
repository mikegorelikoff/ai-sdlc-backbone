...
| --- | --- | --- | --- |
| [`v4.3.1`](https://github.com/mikegorelikoff/ai-sdlc-harness/tree/v4.3.1) | `4.1.0` | Current stable release; preserves the graph explorer while satisfying the TOON-only repository boundary and strict skill-router budget on Python 3.10 and 3.13 | No API migration; use this correction for every new or updated installation |
