...
| Role lane | Skills |
| --- | --- |
| Cross-lifecycle guided entry | `ai-sdlc-flow` |
...
| --- | --- | --- |
| Explore / resume | `ai-sdlc-flow` | Read-only route card with detected context, required next action, expected artifact, blockers, and one fingerprinted Apply checkpoint. |
