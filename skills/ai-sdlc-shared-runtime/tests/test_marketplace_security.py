...
SKILLS = ROOT / "skills"
COMPATIBILITY = SKILLS / "ai-sdlc-shared-runtime" / "scripts" / "ai_sdlc_compatibility.py"
...
class MarketplaceSecurityContractTests(unittest.TestCase):
    ...
    def test_approval_skill_requires_redaction_before_recording(self) -> None:
        text = contract_text(SKILLS / "ai-sdlc-approvals-sandbox")
    ...
    def test_compatibility_does_not_execute_target_python(self) -> None:
        ...
        forbidden = (
            ...
            'root / "skills/ai-sdlc-shared-runtime/scripts/ai_sdlc_modules.py"',
        )
