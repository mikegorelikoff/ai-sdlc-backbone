...
- Use `references/diagnostics.toon` as the deterministic check registry.
- Validate inventories with `references/upgrade-inventory.schema.toon`.
...
7. Emit canonical TOON records; require a later authorized workflow to apply them.
