...
| DEC-002 | 2026-08-17 | accepted | maintainer | Replace the premature one-skill legacy object-notation design with five stage-oriented skills, one shared runtime, canonical step manifests, and TOON-only durable contracts | User explicitly corrected that Loop requires several skills and that the AI SDLC product family always uses TOON | One monolithic skill with non-TOON encoding; copied full Harness catalog; fixed minimal skill graph with TOON | requirements.md; design.md; test-cases.md; tasks.md; Loop runtime and installer | FR-001; FR-002; FR-003; FR-006; FR-008; FR-010; AC-001; AC-002; AC-004; AC-006; AC-008 |
...
| DEC-008 | 2026-09-01 | accepted | user / maintainer | Add `engineering-quality-gate` as a mandatory deterministic post-implementation gate; distribute it as `ai-sdlc-engineering-quality-gate` in Harness core and as `ai-sdlc-loop-engineering-quality-gate` in Loop | The user requires repository-grounded adversarial review, safe High/Medium fixes, rerun verification, evidence-based reporting, deterministic behavior, and core placement; existing namespaces require product-owned IDs | Reuse code review only; add a Loop-only gate; add one canonical Harness skill plus an autonomous Loop adaptation and mandatory Loop route | requirements.md; design.md; test-cases.md; qa.md; tasks.md; plan.md; modules/core/module.toon; skills/ai-sdlc-engineering-quality-gate; products/ai-sdlc-loop | FR-017; FR-018; FR-019; FR-020; NFR-010; NFR-011; AC-015; AC-016; AC-017; AC-018; AC-019; TC-032; TC-033; TC-034; TC-035; TC-036; TC-037; TC-038; TC-039 |
