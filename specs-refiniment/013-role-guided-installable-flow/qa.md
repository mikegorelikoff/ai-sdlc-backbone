...
artifact_metadata:
  ...
  artifact: "qa.md"
  path: "specs-refiniment/013-role-guided-installable-flow/qa.md"
...
- TC-001 clear intent; TC-002 ambiguity menu; TC-003 role handoff; TC-004 missing runtime; TC-005 fingerprint drift; TC-006 installed smoke.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Regression Targets
- All 44 skills, shared helpers, SDD gates, config resolution, context engine, docs generation, and install/update guidance.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Risk-Based Coverage
- Highest priority: importability and Apply drift rejection. Medium: menu/config behavior. Lower: presentation formatting.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Test Data and Environment
- Temporary repositories and temporary user roots; no real global install state and no network unless explicitly authorized.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Validation Commands
- Run focused unit suites, all-skill tests, docs checks, project/selective/global install smoke, and `git diff --check`.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Manual Checks
- Read each role card/menu and V2 Markdown card as a contributor; confirm no external comparison name or fictional persona appears.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Signoff Criteria
- All automated gates pass and independent review finds no role overreach, hidden future-step preload, or package ambiguity.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.
