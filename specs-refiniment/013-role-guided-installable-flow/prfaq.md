...
artifact_metadata:
  ...
  artifact: "prfaq.md"
  path: "specs-refiniment/013-role-guided-installable-flow/prfaq.md"
...
## Press Release
- AI SDLC contributors can now start with one guided flow that explains who is active, what happens next, and why, while every helper uses one installable runtime.

## Customer FAQ
- Users keep one flow entrypoint and direct advanced skills. Clear intent dispatches directly; ambiguity produces a small role-specific menu.

## Internal FAQ
- The change keeps 44 skills, removes `_shared`, emits V2 cards only, and makes selectors the source for generated role discovery.

## Business Requirements
- REQ-001 through REQ-004 and AC-001 through AC-005 define the delivery contract.

## Launch Risks
- A broken import, stale generated doc, or selector mismatch blocks release; no partial-success claim is allowed.
