...
artifact_metadata:
  ...
  path: "specs-refiniment/013-role-guided-installable-flow/test-cases.md"
...
| --- | --- | --- | --- | --- |
| SC-001 | Feature 013 requirement ref | Feature 013 type | Feature 013 preconditions | Feature 013 expected outcome |
...
| --- | --- | --- | --- | --- | --- |
| TC-001 | Feature 013 scenario ref | Feature 013 steps | Feature 013 expected result | must | Feature 013 automation |

- The matrix is bounded to the accepted Feature 013 scope and traces to DEC-001.

## Permission and Negative Cases
- Reject arbitrary actions, unsafe reference paths, missing dependency, ambiguous aliases, stale cards, and unauthorized Apply.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Expected Results
- Every failure is fail-closed, names the exact cause, and leaves repository/user state unchanged.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Layer Mapping
- Selector/config unit tests; flow/context integration tests; installed runtime/system smoke; docs/manual acceptance.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.
