...
artifact_metadata:
  ...
  path: "specs-refiniment/013-role-guided-installable-flow/user-stories.md"
...
| --- | --- | --- | --- | --- | --- | --- |
| US-001 | EPIC-001 | Feature 013 actor | Feature 013 story | Feature 013 value | must | yes |
...
| --- | --- | --- | --- | --- | --- |
| AC-001 | US-001 | Feature 013 given | Feature 013 when | Feature 013 then | Feature 013 rule covered |
...
| --- | --- | --- | --- | --- | --- |
| SC-001 | US-001 | Feature 013 type | Feature 013 trigger | Feature 013 expected outcome | Feature 013 ac ref |

- The matrix is bounded to the accepted Feature 013 scope and traces to DEC-001.

## Story Dependencies and Risks
- Runtime and selector stories precede documentation and full installed validation.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Story Readiness
- Stories are ready and bounded by the accepted action/role/runtime contracts.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.
