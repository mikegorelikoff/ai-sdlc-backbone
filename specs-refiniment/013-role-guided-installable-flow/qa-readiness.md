...
artifact_metadata:
  ...
  path: "specs-refiniment/013-role-guided-installable-flow/qa-readiness.md"
...
| --- | --- | --- | --- | --- | --- |
| REQ-001 | AC-001 | TC-001 | Feature 013 suite | ready | No blocking gap |

- The matrix is bounded to the accepted Feature 013 scope and traces to DEC-001.

## Risk Coverage
- RISK-001 covered by import/install suites; RISK-002 by exhaustive mapping tests; RISK-003 by JIT/economics tests.
...
| --- | --- | --- | --- | --- |
| Feature 013 evidence area | Feature 013 required signal | yes | No blocking gap | Feature 013 impact |

- The matrix is bounded to the accepted Feature 013 scope and traces to DEC-001.

## Blocked Coverage
- None; network-dependent remote smoke may be reported separately if the environment blocks access.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.
