...
artifact_metadata:
  ...
  path: "specs-refiniment/013-role-guided-installable-flow/business-context.md"
...
## Current Behavior
- Flow chooses roles and routes from hard-coded Python, while consumers prefer `_shared` in source and a mirrored runtime after installation.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Desired Behavior
- One trusted selector registry chooses the action, actual next owner, role reference, and current step; one canonical runtime serves every layout.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.

## Actor and Permission Matrix
| Actor | Role | Permissions | Restrictions | Source |
| --- | --- | --- | --- | --- |
| Feature 013 actor | Feature 013 role | Feature 013 permissions | Feature 013 restrictions | DEC-001 and accepted plan |
...
| --- | --- | --- | --- | --- | --- | --- |
| Feature 013 workflow id | Feature 013 trigger | Feature 013 actor | Feature 013 steps | Feature 013 end state | Feature 013 exceptions | DEC-001 and accepted plan |
...
| --- | --- | --- | --- | --- | --- |
| Feature 013 rule id | Feature 013 rule | Feature 013 applies to | Feature 013 failure behavior | DEC-001 and accepted plan | DEC-001 |
...
| --- | --- | --- | --- | --- | --- |
| AC-001 | Feature 013 given | Feature 013 when | Feature 013 then | Feature 013 rule ref | DEC-001 and accepted plan |

- The matrix is bounded to the accepted Feature 013 scope and traces to DEC-001.

## Business Context Gaps
- None blocking; authority boundaries are fixed by the five role contracts and human responsibility model.
- Evidence is the accepted plan, inspected repository contracts, and completed upstream Feature 013 artifacts.
