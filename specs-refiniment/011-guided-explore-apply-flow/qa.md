...
artifact_metadata:
  ...
  artifact: "qa.md"
  path: "specs-refiniment/011-guided-explore-apply-flow/qa.md"
...
## Validation Commands
`python3 skills/ai-sdlc-shared-runtime/scripts/refinement_status.py --feature 011-guided-explore-apply-flow --gate full` plus focused flow, navigator, path, context, review, catalog, docs, and compatibility tests. Exact code-test commands belong to the later SDD.

## Manual Checks
Verify the Explore card and zero writes as a newcomer; introduce drift and confirm Apply blocks; review a seeded change before rationale and independently detect the bug and readability violation.
