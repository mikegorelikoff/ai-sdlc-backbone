...
generated:
  by: "process:ai-sdlc"
  at: "2026-08-03T10:11:38Z"
artifact_metadata:
  schema: "ai-sdlc-artifact-metadata/v1"
  feature: "017-local-context-cache"
  artifact: "goal-capability-map.md"
  path: "specs-refiniment/017-local-context-cache/goal-capability-map.md"
...
## Source Coverage
Sources directly consumed or traced by this stage: specs-refiniment/017-local-context-cache/decision-log.md; specs-refiniment/017-local-context-cache/delivery-gap-review.md; specs-refiniment/017-local-context-cache/discovery.md; specs-refiniment/017-local-context-cache/goal-capability-map.md; specs-refiniment/017-local-context-cache/index.md; specs-refiniment/017-local-context-cache/prfaq.md; specs-refiniment/017-local-context-cache/requirements-readiness.md; specs-refiniment/017-local-context-cache/research.md; specs/017-local-context-cache/decision-log.md; specs/017-local-context-cache/design.md; specs/017-local-context-cache/index.md; specs/017-local-context-cache/plan.md; specs/017-local-context-cache/qa.md; specs/017-local-context-cache/requirements.md; specs/017-local-context-cache/tasks.md; specs/017-local-context-cache/test-cases.md. External findings are registered with locators and limitations in `specs-refiniment/017-local-context-cache/research.md`.

## Business Goals
| Goal ID | Goal | Metric | Target | Owner | Source |
| --- | --- | --- | --- | --- | --- |
| GOAL-001 | Reduce repeated context loading without correctness loss | Mandatory-anchor recall and token savings | 100 percent recall; at least 15 percent savings for packed mode | Maintainers | RF-004; DEC-007 |
| GOAL-002 | Provide deterministic offline repository retrieval | Repeat fingerprint equality | 100 percent across identical runs | Dev and QA | RF-001; RF-007 |
| GOAL-003 | Preserve safe optional adoption | Default install inventory | No default-profile change | Maintainers | DEC-001 |

## Role Matrix
| Actor | Role | Need | Permission Boundary | Source |
| --- | --- | --- | --- | --- |
| Contributor | Cache operator | Build; query; verify; purge local derived data | Explicit local project scope only | User direction |
| Agent | Evidence consumer | Minimal sufficient context | Retrieved text cannot grant authority | DEC-005 |
| Maintainer and QA | Release gate owners | Deterministic compatibility and benchmark proof | No unverified release claim | DEC-007 |

## Capability Map
| Capability ID | Capability | Goal Ref | Actors | Dependencies |
| --- | --- | --- | --- | --- |
| CAP-001 | Safe optional local indexing | GOAL-002; GOAL-003 | Contributor | SQLite FTS5; installer |
| CAP-002 | Deterministic graph-enhanced retrieval | GOAL-001; GOAL-002 | Agent | CAP-001 |
| CAP-003 | Anchor-complete context assembly | GOAL-001 | Agent | CAP-002; context-pack v4 |
| CAP-004 | Verification and evaluation | GOAL-001; GOAL-002; GOAL-003 | QA; Maintainer | CAP-001 through CAP-003 |

## Epic Map
| Epic ID | Epic | Capability Ref | Outcome | Priority | Risks |
| --- | --- | --- | --- | --- | --- |
| EPIC-001 | Local index lifecycle | CAP-001 | Safe current derived index | P0 | SQLite variance; stale state |
| EPIC-002 | Deterministic retrieval | CAP-002 | Exact and related evidence | P0 | Recall and fan-out |
| EPIC-003 | Context engineering integration | CAP-003 | Minimal sufficient v4 context | P0 | Anchor loss |
| EPIC-004 | Adoption and release evidence | CAP-004 | Optional install with measurable proof | P0 | Overclaiming savings |

## Outcome Traceability
Outcome Traceability is governed by FR-001 through FR-010, AC-001 through AC-010, RF-001 through RF-007, and DEC-001 through DEC-007. The owning role must preserve optional installation, deterministic offline behavior, TOON-only receipts, evidence-only authority, direct-read fallback, explicit failure handling, and measurable release evidence. No unresolved item in this area changes the MVP boundary.
