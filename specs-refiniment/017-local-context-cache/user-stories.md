...
generated:
  by: "process:ai-sdlc"
  at: "2026-08-03T10:12:09Z"
artifact_metadata:
  schema: "ai-sdlc-artifact-metadata/v1"
  feature: "017-local-context-cache"
  artifact: "user-stories.md"
  path: "specs-refiniment/017-local-context-cache/user-stories.md"
...
## Source Coverage
Sources directly consumed or traced by this stage: specs-refiniment/017-local-context-cache/backlog-gap-review.md; specs-refiniment/017-local-context-cache/backlog.md; specs-refiniment/017-local-context-cache/decision-log.md; specs-refiniment/017-local-context-cache/delivery-gap-review.md; specs-refiniment/017-local-context-cache/discovery.md; specs-refiniment/017-local-context-cache/goal-capability-map.md; specs-refiniment/017-local-context-cache/index.md; specs-refiniment/017-local-context-cache/prfaq.md; specs-refiniment/017-local-context-cache/requirements-readiness.md; specs-refiniment/017-local-context-cache/research.md; specs-refiniment/017-local-context-cache/user-stories.md; specs/017-local-context-cache/decision-log.md; specs/017-local-context-cache/design.md; specs/017-local-context-cache/index.md; specs/017-local-context-cache/plan.md; specs/017-local-context-cache/qa.md; specs/017-local-context-cache/requirements.md; specs/017-local-context-cache/tasks.md; specs/017-local-context-cache/test-cases.md. External findings are registered with locators and limitations in `specs-refiniment/017-local-context-cache/research.md`.

## Story Detail Matrix
| Story ID | Epic ID | Actor | Story | Value | Priority | MVP |
| --- | --- | --- | --- | --- | --- | --- |
| STORY-001 | EPIC-004 | Contributor | Opt into local cache installation | Preserve compatibility | P0 | Yes |
| STORY-002 | EPIC-001 | Contributor | Build and refresh safe derived state | Avoid repeated full reads | P0 | Yes |
| STORY-003 | EPIC-002 | Agent | Find exact and related evidence | Improve context utility | P0 | Yes |
| STORY-004 | EPIC-003 | Agent | Compile sufficient bounded context | Save tokens safely | P0 | Yes |
| STORY-005 | EPIC-004 | QA | Verify and benchmark behavior | Support evidence-based release | P0 | Yes |

## Acceptance Criteria Matrix
| AC ID | Story ID | Given | When | Then | Rule Covered |
| --- | --- | --- | --- | --- | --- |
| AC-001 | STORY-001 | Default and module profiles | Installation runs | Default has 45 skills and module has 46 | BR-001 |
| AC-003 | STORY-002 | Changed and deleted fixture files | Refresh runs | State equals a clean rebuild | BR-004 |
| AC-005 | STORY-003 | Exact ID and related decision | Query runs twice | Same ranked seed and bounded related evidence appear | BR-004 |
| AC-006 | STORY-004 | StepCard and declared anchors | Pack runs | StepCard and 100 percent anchors are retained | BR-003 |
| AC-007 | STORY-004 | Net savings below 15 percent | Pack runs | Strategy is direct_read | BR-003 |
| AC-010 | STORY-005 | Golden suite | Benchmark runs twice | Metrics pass and fingerprints match | BR-005 |

## Scenario Coverage Matrix
| Scenario ID | Story ID | Type | Trigger | Expected Outcome | AC Ref |
| --- | --- | --- | --- | --- | --- |
| SCN-001 | STORY-002 | Primary | Clean build | Consistent verified index | AC-002; AC-003 |
| SCN-002 | STORY-002 | Failure/retry | Interrupted refresh | Transaction rolls back | AC-003 |
| SCN-003 | STORY-003 | Boundary | Graph limit reached | Stable bounded results | AC-005 |
| SCN-004 | STORY-004 | Negative | Anchor missing | Explicit direct_read | AC-006 |
| SCN-005 | STORY-004 | Security | Retrieved injection text | Evidence is not executed | AC-008 |
| SCN-006 | STORY-005 | Regression | Repeat benchmark | Identical fingerprint | AC-010 |

## Story Dependencies and Risks
STORY-001 optional installation enables all other stories. STORY-002 transactional indexing precedes query. STORY-003 lexical and graph search precedes context packing. STORY-004 safe context packing depends on StepCard and critical-anchor inputs. STORY-005 verification and benchmarking gates release. Key risks are stale data, anchor loss, unsafe evidence, high fan-out, poor recall, and misleading savings; each maps to negative tests.

## Story Readiness
All MVP stories are ready for SDD refinement with explicit actors, value, acceptance logic, dependencies, MVP status, and risks. Roadmap stories for embeddings and full GraphRAG are intentionally not implementation-ready and remain excluded. No testable behavior relies on an unnamed user, unknown permission, fake timeline, or external service.
